...
int analyze_RMSF(MMatrix_t posOS, MMatrix_t densOS, MMatrix_t mr, MMatrix_t mr2, int nOS, float L[3]);
int Averaging(MMatrix_t densOS, MMatrix_t mr, MMatrix_t mr2, int nOS);
int Output(MMatrix_t densOS, MMatrix_t mr, MMatrix_t mr2, MMatrix_t rmsf, int nOS, int totalSection, char *fnRDF);
