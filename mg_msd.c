...
int main(int argc,char *argv[])
{
  ...
  static int  ng=1, snp, interval=1;
  t_pargs pa[] = {
    { "-snp",      FALSE, etINT,  {&snp},      "# of frames" },
    { "-ng",       FALSE, etINT,  {&ng},       "# of index grp to read" },
    { "-interval", FALSE, etINT,  {&interval}, "frequency of restart points" },
 ...
 **/
  do_msd(fnTPS, fnTRX, fnRDF,
         ng, isize, grpname, index,
         snp, dT, chunk, bMW, interval);
