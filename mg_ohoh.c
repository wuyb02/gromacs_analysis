...
int main(int argc,char *argv[])
{
  ...
  static char *desc[] = {
    ...
    "Modified, By Yanbin, 04/29/2009\n"
    "Water Orientation Above Graphene Surface by distance and angle\n"
  };

  static int  ng=1, snp=1;
  static real dT = 0.05;
  static real gridsize=0.01, dtheta=0.01, zdis=0.01;
  t_pargs pa[] = {
    ...
    { "-dtheta",   FALSE, etREAL, {&dtheta},   "dtheta"},
    { "-zdis",     FALSE, etREAL, {&zdis},     "zdis"},
  };
  #define NPA asize(pa)
 ...
 **/
  do_ohoh(fnTPS, fnTRX, fnRDF, ng, isize, grpname, index, snp, dT, gridsize, dtheta, zdis);
