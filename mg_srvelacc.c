#include "mg_srvelacc.h"

int main(int argc,char *argv[])
{
  int i,j,k,ll,mm,nn;
  static char *desc[] = {
    "g_velacc with spherical radial bins\n"
    "mg_srvelacc -f md01.trr -s md01-331.tpr -n index.ndx -o vac_Hmg.xvg -dt 0.001 -dT 0.001 -snp 200000 -ng 1 -nskipt0 10 -chunk 5.0001 -xc 1.0 -yc 1.0 -zc 1.0 -r1 0 -r2 10 -nobMW\n"
  };
  ...
  static real xc = 1.0, yc = 1.0, zc = 1.0, r1 = 0.0, r2 = 10.0;
  ...
  t_pargs pa[] = {
    ...
    { "-xc",       FALSE, etREAL, {&xc},       "ball center x" },
    { "-yc",       FALSE, etREAL, {&yc},       "ball center y" },
    { "-zc",       FALSE, etREAL, {&zc},       "ball center z" },
 ...
 **/
  do_srvelacc(fnTPS, fnTRX, fnRDF,
         ng, isize, grpname, index,
         snp, dT, chunk, bMW, xc, yc, zc, r1, r2, nskipt0);
